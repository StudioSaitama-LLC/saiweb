    ...
    <div className="hero-gradient py-24 snap-start">
      <div className="max-w-7xl mx-auto px-6">
        <div className="space-y-10 japanese-text text-left">
          <p className="text-2xl md:text-3xl lg:text-4xl text-blue-500 mb-8">
            「それ、意味あるの？」って言われることに、どこか惹かれてしまう。
          </p>
          <div className="text-[24px] text-blue-500 leading-[2.4] space-y-6">
            <p>
        ...
        {/* SPECIALITYセクション */}
        <div className="mt-32">
          <div className="text-[256px] font-extrabold text-left text-[#3B82F6] leading-[0.8] tracking-[-0.02em] font-inter">SPECIALITY</div>
          <div className="text-[36px] text-blue-500 mt-8 font-bold">現場でブリコラージュし、領域を跨いでサイ適を描く</div>

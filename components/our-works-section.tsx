  ...
  const projects = [
    {
      ...
      image: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/wazaoipponbackground.jpg`,
    ...
    },
    {
      ...
      image: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/images/ツカノマノスゴイサウナ.jpg`,
                ...
                <div className="text-[#F5F7FA] space-y-8 font-intel">
                  ...
                  {project.link && (
                    <a 
                      ...
                      className="inline-block mt-12 bg-[#F5F7FA]/10 hover:bg-[#F5F7FA]/20 text-[#F5F7FA] px-8 py-3 rounded-full text-base font-medium transition-colors duration-300 backdrop-blur-sm border border-[#F5F7FA]/20"
                    >
                      GO WEB
                    </a>
                  )}

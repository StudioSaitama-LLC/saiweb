...
export function SpecialitySection() {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 mt-32 mb-32">
      <div className="font-extrabold text-left text-[#3B82F6] leading-[0.8] tracking-[-0.02em] font-inter text-[clamp(40px,16vw,256px)]">SPECIALITY</div>
